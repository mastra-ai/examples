...
export type AgentNameType = 'Stock Analyst' | 'Crypto Analyst'
...
const assistantMap: Record<AgentNameType, string> = {
  ...
  'Crypto Analyst': 'asst_tmPzSUhBwdXlIYGEg5eSzsA9',
  'Stock Analyst': 'asst_aTCw0swxoUyElwxNrEOu3d9F'
}
...
export function Chat({ id, className, session, missingKeys }: ChatProps) {
  ...
  const [assistant, setAssistant] = useState(assistantMap['Crypto Analyst'])
  const [assistantName, setAssistantName] = useState('Crypto Analyst')
